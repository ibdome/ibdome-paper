...
ggsave(file.path(params$artifact_dir, "SupplementaryFigure2A.pdf"), width = 6, height = 4)
``` 
...
ggsave(file.path(params$artifact_dir, "SupplementaryFigure2B.pdf"), width = 4, height = 6)
``` 
...
pdf(file.path(params$artifact_dir, "SupplementaryFigure2C.pdf"), width = 6, height = 2)
corrplot(p_cor, col = colorRampPalette(c("blue", "white", "red"))(10), tl.col="black")
dev.off()
``` 
...
ggsave(file.path(params$artifact_dir, "SupplementaryFigure2D.pdf"), width = 10, height = 6)
``` 
